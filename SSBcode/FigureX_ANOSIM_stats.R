...
orditorp(nmds,display="species",col="red",air=0.01)
orditorp(nmds,display="sites",col=c(rep("green",3),rep("blue",3), rep("orange",5)),
         air=0.01,cex=1.25)
colors=c(rep("red",3),rep("blue",3), rep("orange",5))
ordiplot(nmds,type="n")
...
orditorp(nmds,display="sites",col=c(rep("red",3),
                                            rep("blue",3), rep("orange",5)),air=0.01,cex=1.25)
